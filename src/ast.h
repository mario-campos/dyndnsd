...
struct ast_domain {
	const char     *name;
	const struct ast_domain *next;
	const char     *url;
};

struct ast_iface {
	const struct ast_domain *domains;
	const char     *name;
	const struct ast_iface *next;
	const char     *url;
};

struct ast {
	const struct ast_iface *interfaces;
	const char     *url;
};
 ...
 */
struct ast_iface *ast_new_iface(const char *, const struct ast_domain *, const char *);
